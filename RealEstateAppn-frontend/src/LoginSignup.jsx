            ...
            <div className="container">
                <div className="row gx-lg-5 align-items-center">
                        ...
                        <div className="card">
                            <div className="card-body py-5 px-md-5">
                                <div className="d-flex justify-content-between align-items-center mb-4">
                                    <h1 style={{ color: "#ca8543" }}>Real Estate</h1>
                                    <button className="btn1" onClick={toggleForms}>
                    ...
                    <div className="col-lg-6">
                        <h1 className="my-5 display-3 fw-bold ls-tight">All-in-one real<br /><span className="text">estate Platform!</span></h1>
