    ...
    <div className="container-fluid nav-bar bg-transparent mt-0">
      <nav className="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
        <Link to="/" className="navbar-brand d-flex align-items-center text-center">
          <h1 className="m-0 logo">Real Estate</h1>
        </Link>
            ...
            <Dropdown.Menu>
              {localStorage.getItem('token') ? (
                <>
                  ...
                  <Dropdown.Item href="/wishlist">Wishlist <span style={{marginLeft: 10, display: 'inline-block', width: 30, height: 20, borderRadius: '50%', backgroundColor: 'red', color: 'white', textAlign: 'center', lineHeight: '18px'}}>{wishlist.length}</span></Dropdown.Item>
